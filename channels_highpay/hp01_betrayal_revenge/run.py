"""
run.py for hp01_betrayal_revenge — auto-generated. Run with:
    python3 -m channels_highpay.hp01_betrayal_revenge.run
    python3 -m channels_highpay.hp01_betrayal_revenge.run --upload
    python3 -m channels_highpay.hp01_betrayal_revenge.run --topic "..."
"""
import argparse
import sys
import os
...
from channels_highpay.hp01_betrayal_revenge.config import CONFIG
